...
from . import views
from .views import PostCreateView, PostListView, PostDetailView, PostDeleteView, PostUpdateView, search_post
...
urlpatterns = [
    ...
    path(tags/<slug:tag_slug>/", PostByTagListView.as_view(), name='post_tag')
]
